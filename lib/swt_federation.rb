...
REALM='http://0.0.0.0:8080/login/'
TOKEN_TYPE='http://schemas.xmlsoap.org/ws/2009/11/swt-token-profile-1.0' #SWT
ISSUER='https://southworksinc.accesscontrol.windows.net/'
TOKEN_KEY='g+TdDqlkiDkOok2HremDwJOo6DFrZ14RPEzT9Ic3Cow='
